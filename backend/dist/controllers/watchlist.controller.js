...
export const add = async (req, res) => {
    try {
        ...
        const { id: movie_id, title, original_title, original_name, name, overview, poster_path, backdrop_path, original_language, release_date, adult, genre_ids, popularity, vote_average, vote_count, video } = movieData;
